...
export BATCHSIZE=2
export EXTRA_PARAMS=""
export EXTRA_CONFIG='SOLVER.BASE_LR 0.06 SOLVER.WARMUP_FACTOR 0.000192 SOLVER.WARMUP_ITERS 625 SOLVER.WARMUP_METHOD mlperf_linear SOLVER.STEPS (48000,60000) SOLVER.IMS_PER_BATCH 32 TEST.IMS_PER_BATCH 32 MODEL.RPN.FPN_POST_NMS_TOP_N_TRAIN 12000 MODEL.RPN.FPN_POST_NMS_TOP_N_PER_IMAGE False NHWC True'
...
export MLPERF_HOST_OS="Ubuntu 20.04.5 LTS / NVIDIA DGX Server 5.2.0"
export CONT=cr.backend.ai/mlperf/maskrcnn:22.04
export DATADIR="/home/devops/mlperf_dataset/maskrcnn/dataset_scripts"
export LOGDIR="/home/devops/mlperf_dataset/maskrcnn/logdir"
